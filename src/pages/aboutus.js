  ...
  return (
    <div className="aboutus">
      ...
      <div className="content">
        ...
        <span>
          Zermatt ist ein erstklassiges Skireiseziel, <span className="bspan">bekannt </span> ,für sein umfangreiches Skigelände mit miteinander verbundenen Pisten, die für alle Könnensstufen geeignet sind.
        </span>
        <div className="news">
  <div className="news-card">
    <img src={news1Img} alt="Swiss Alps" className="news-image" />
    <h4>Neuer Skilift in den Alpen eröffnet!</h4>
    <p>Höhere Kapazität und schnellere Aufstiegszeiten für Wintersportler!</p>
  </div>
  <div className="news-card">
    <img src={news2Img} alt="Swiss Alps" className="news-image" />
    <h4>Alpenregion erlebt Rekordschnee...</h4>
    <p>Große Mengen Schneefall führen zu idealen Bedingungen für Skifahrer und Snowboarder.</p>
  </div>
  <div className="news-card">
    <img src={news3Img} alt="Swiss Alps" className="news-image" />
    <h4>Umweltfreundliche Initiative gestartet!</h4>
    <p>Alpenhotels setzen verstärkt auf Nachhaltigkeit, um die einzigartige Bergwelt zu schützen.</p>
  </div>
</div>
